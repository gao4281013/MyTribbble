...
class CommentAdapter( val mShot: Shot,
    ...
    override fun onCreateViewHolder(parent: ViewGroup?, viewType: Int): ViewHolder {
        if (viewType == COMMENT){
            ...
            return ViewHolder(
                LayoutInflater.from(parent?.context).inflate(R.layout.item_details_head, parent,
                    false))
        }
  }
  ...
  inner class ViewHolder(itemView:View):RecyclerView.ViewHolder(itemView) {
      ...
      fun bindShotInfo(shot: Shot){
          ...
          itemView.mAttachmentCountBtn.setOnClickListener { countClick(Constant.DETAILS_EVENT_AYYACHMENT_COUNT) }

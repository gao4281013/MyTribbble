...
object Utils {
    ...
    fun sp2px(sp: Int): Float {
        return applyDimension(TypedValue.COMPLEX_UNIT_SP, sp.toFloat(), App.instance.displayMetrics)
    }
    ...
    fun dp2px(dp: Int): Float {
        return applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp.toFloat(), App.instance.displayMetrics)
    }

    fun dp2px(dp: Float): Float {
        return applyDimension(TypedValue.COMPLEX_UNIT_DIP, dp, App.instance.displayMetrics)
    }
